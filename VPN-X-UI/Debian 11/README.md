...
Input the RAM you want to swap, normally it is 2 * orginial RAM <br>
For example, the original RAM of the linux server is 1G = 1024 MB, then we input 2048 here <br>
